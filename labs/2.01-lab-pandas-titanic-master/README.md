...
3. Create a Jupyter notebook and load the csv into pandas.
...
1. Reverends have a special title in their name. Create a column called `IsReverend`: 1 if they're a preacher, 0 if they're not.
...
1. Create another plot of your choice and explain in words something that it shows.
