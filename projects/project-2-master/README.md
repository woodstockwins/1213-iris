...
2. **IMPORTANT**: Click this link: [Regression Challenge Sign Up](https://www.kaggle.com/c/dsir1213) to **join** the competition (otherwise you will not be able to make submissions!)
